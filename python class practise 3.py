...
>>> s.index("c")
5
>>> sms="ABC123. Confirmed! Hi Joy, your balance is 1000."
>>> sms[0:7]
'ABC123.'
>>> s[23:26]
''
...
'balance'
>>> sms.upper()
'ABC123. CONFIRMED! HI JOY, YOUR BALANCE IS 1000.'
>>> sms.capitalize()
'Abc123. confirmed! hi joy, your balance is 1000.'
>>> sms.lower()
'abc123. confirmed! hi joy, your balance is 1000.'
...
'ABC123. Confirmed! Hi Joy, your balance is 10000.'
>>> length(sms)
Traceback (most recent call last):
